          ...
          <div className="h-72 rounded border p-4 bg-[var(--color-bg-surface)]" style={{ borderColor: 'var(--color-border)' }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={avgByGradeOrdered} margin={{ top: 8, right: 8, left: 32, bottom: 24 }}>
                ...
                <Tooltip formatter={(value: number | string | undefined) => [typeof value === 'number' ? Number(value).toFixed(1) : value ?? 'N/A', 'Avg Score (pts)']} />
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  />
                  <Tooltip formatter={(value: number | string | undefined) => [typeof value === 'number' ? Number(value).toFixed(1) : value ?? 'N/A']} />
                  <Legend />
          ...
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={supportTrendRows} margin={{ top: 8, right: 16, left: 16, bottom: 24 }}>
                ...
                />
                <Tooltip formatter={(value: number | string | undefined, name?: string) => [name === '% Needs Support' && typeof value === 'number' ? Number(value).toFixed(1) + '%' : value ?? 'N/A', name ?? 'Value']} />
                <Legend />
                <Bar
                  yAxisId="left"
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                <YAxis
                  ...
                  interval={0}
                />
                <Tooltip formatter={(value: number | string | undefined) => [typeof value === 'number' ? Number(value).toFixed(1) : value ?? 'N/A', 'Avg Score']} />
